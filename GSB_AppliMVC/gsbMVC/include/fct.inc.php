 ...
 * @return la date au format format anglais jj-mm-aaaa
 */
function dateJourAnglais(){
	$annee = date("o");
	$moisDate = date("m");
	$jour = date("d") ;
 ...
 */
function ajoutMois($mois){
	$annee = substr($mois,0,4);
	$moisDate = substr($mois,4,2);
	$moisDate = intval($moisDate) + 1 ;
	if ($moisDate > 12){
