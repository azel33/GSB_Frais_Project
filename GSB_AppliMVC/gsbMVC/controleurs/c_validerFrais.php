...
// Selon les valeurs de $_REQUEST['action'] inclusion des diff�rents vues
	switch($action) {
		...
		case 'selectionnerMois' :
			...
			// et que aucun mois n' a été sélectionné on retourne � la selection du visiteur.
		...
		case 'reportFraisForfait' :
		    ...
		    //cree une nouvelle ligne de frais hors forfait avec les �l�ment de celle report�.
